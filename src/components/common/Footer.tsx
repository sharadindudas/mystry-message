...
const Footer = () => {
    return (
        <footer className="bg-color-1 text-white border-t border-t-color-2/15 py-12 mt-auto">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-color-4 mb-4 text-sm">
                            Stay updated with our latest features and releases.
                        </p>
                        <form className="flex flex-col sm:flex-row gap-4 sm:gap-">
                            <Input
                                type="email"
